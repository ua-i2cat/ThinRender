...
#ifndef PICK_RENDER_TO_TEXTURE_H
#define PICK_RENDER_TO_TEXTURE_H

#include "BasicRTT.h"
#include "../../shader/basic/ColorShader.h"
#include "../../shader/Shader.h"

class PickRTT : public BasicRTT {
public:
	PickRTT();
	~PickRTT();
    ...
    ///ColorShader renders only plane color
	ColorShader* colorShader;
	unsigned int previousPickId;
	int xSelectedScreen, ySelectedScreen;
};
