 ...
 * Copyright (C) 2013 i2CAT Foundation
 *
...
void audioCreateBufferQueueAudioPlayer()
{
    SLresult result;
...
bool audioEnableReverb(bool enabled)
{
    SLresult result;
...
void audioSetPlayingAssetAudioPlayer(bool isPlaying)
{
    SLresult result;
