...
#ifndef VOLUME_TEXTURE_SHADER_H
#define VOLUME_TEXTURE_SHADER_H
...
class VolumeTextureShader : public Shader{
public:
	VolumeTextureShader();
    /**
	...
	GLint uniformTexture, uniformCount;
private:
	float uniformCountX, uniformCountY;
	float internalTimer;
};
