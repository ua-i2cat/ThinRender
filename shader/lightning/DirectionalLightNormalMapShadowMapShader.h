...
#ifndef DIRECTIONAL_LIGHT_NORMAL_MAP_SHADOW_MAP_SHADER_H
#define DIRECTIONAL_LIGHT_NORMAL_MAP_SHADOW_MAP_SHADER_H
...
class DirectionalLightNormalMapShadowMapShader : public Shader {
public:
	DirectionalLightNormalMapShadowMapShader();
	/**
    ...
    /**
     * loadTexture is a function to bind the texture2D
	...
	GLint uniformLightProjectionMatrix, uniformLightViewMatrix;
	GLint uniformDepthTexture, /*uniformNormalTexture, */uniformTexture;
