...
#ifndef DIRECTIONAL_LIGHT_NORMAL_MAP_SHADER_H
#define DIRECTIONAL_LIGHT_NORMAL_MAP_SHADER_H
...
class DirectionalLightNormalMapShader : public Shader {
public:
	DirectionalLightNormalMapShader();
	/**
	...
	GLint uniformNormalTexture, uniformTexture;
