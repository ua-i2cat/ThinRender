...
#ifndef DIRECTIONAL_LIGHT_TEXTURED_SHADOW_MAP_SHADER_H
#define DIRECTIONAL_LIGHT_TEXTURED_SHADOW_MAP_SHADER_H
...
class DirectionalLightTexturedShadowMapShader : public Shader {
public:
	DirectionalLightTexturedShadowMapShader();
	...
	GLint uniformLightPosition, uniformLightDirection, uniformLightAmbient;
	GLint uniformLightProjectionMatrix, uniformLightViewMatrix;
	GLint uniformTexture;
	GLint uniformTextureDepth;
};
#endif
