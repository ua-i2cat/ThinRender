...
#include "CameraPreviewPlaneShader.h"
#include "../../log/Log.h"
CameraPreviewPlaneShader::CameraPreviewPlaneShader(){
	logInf("CameraPreviewPlaneShader::CameraPreviewPlaneShader");
	texture = 0;
	hasNormals = false;
	hasTangents = false;
	hasBitangents = false;
...
void CameraPreviewPlaneShader::setVars(glm::mat4 projView, glm::mat4 model, glm::mat4 view, glm::mat4 projection, Light* renderLight, glm::vec4 lightWorldPosition, glm::vec4 light_direction, glm::vec3 light_ambient, glm::mat4 projectionLight, glm::mat4 viewLight, GLuint depthTexture, bool receiveShadows){
 ...
 */
	...
	error = glGetError();
	if(error != GL_NO_ERROR)logErr("CameraPreviewPlaneShader::setVars error 3 error num %i", error);
}
